...
export function assignToNearest(samples, centroids, fillEmpty = true) {
  return tf.tidy(() => {
...
export function fillEmptyClusters(distances, minCount = 1) {
  return tf.tidy(() => {
    ...
    const nInstances = distances.shape[1];
